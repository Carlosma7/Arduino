/*
  ...
  It prints some numbers on the 7-digit display, then a word turning on LEDs in order, and a message indicating to press
  buttons to turn on LEDs.

  Code extracted from: https://blog.3d-logic.com/2015/01/10/using-a-tm1638-based-board-with-arduino/
*/
